    ...
    public void actualizar(Evento evento) {
        try{
            ...
            switch (evento){
                ...
                case INSERTAR_MECANICO -> {modelo.insertar(vista.leerMecanico()); resultado = "Trabajo mecanico insertado correctamente"; }
                ...
                case ANADIR_PRECIO_MATERIAL_TRABAJO -> {modelo.anadirPrecioMaterial(vista.leerTrabajoVehiculo(), vista.leerPrecioMaterial()); resultado = "Precio del material insertado correctamente"; }
                ...
                case BORRAR_TRABAJO -> { modelo.borrar(vista.leerTrabajoVehiculo()); resultado = "Trabajo eliminado correctamente"; }
