...
public class Trabajos implements ITrabajos {
    ...
    public List<Trabajo> get(Vehiculo vehiculo){
        ...
        for (Trabajo v : coleccionTrabajos){
            if (v.getVehiculo().equals(vehiculo)){
                trabajosVehiculos.add(v);
            }
        }
    ...
    private void comprobarTrabajo(Cliente cliente, Vehiculo vehiculo, LocalDate fevchaInicio) throws TallerMecanicoExcepcion {
        for (Trabajo t : coleccionTrabajos){
            if (!t.estaCerrado()){
                if(t.getCliente().equals(cliente)){
            ...
            if (t.estaCerrado() && !t.getFechaFin().isBefore(fevchaInicio)){
                if (t.getCliente().equals(cliente)){
