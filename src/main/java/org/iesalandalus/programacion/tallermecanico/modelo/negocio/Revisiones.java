...
public class Revisiones {
    ...
    public List<Revision> get(Cliente cliente) {
        if (cliente == null) {
            throw new NullPointerException("No se pueden buscar revisiones de un cliente nulo.");
        }
    ...
    public List<Revision> get(Vehiculo vehiculo) {
        if (vehiculo == null) {
            throw new NullPointerException("No se pueden buscar revisiones de un vehículo nulo.");
        }
